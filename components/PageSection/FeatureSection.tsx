    ...
    <div className="relative py-[6.25rem]">
      <div className=" container flex flex-col mx-auto text-center  items-center text-[#333] ">
        ...
        <div className="  z-[2] w-[100%] mt-[4.375rem] justify-start flex-wrap  items-stretch   flex">
          ...
          <div className="flex justify-between border-[2px] rounded-[20px] border-[#333] h-[312px] xl:h-[388px]  bg-[#fae8ce] px-[1.5rem] flex-col pt-[1.5rem] pb-[2rem] w-[25%] mr-[1.5%] mb-[1.5%]">
          ...
          <div className="flex justify-between border-[2px] rounded-[20px] border-[#333] h-[312px] xl:h-[388px]  bg-[#e4f5d7] px-[1.5rem] flex-col pt-[1.5rem] pb-[2rem] w-[34%] mb-[1.5%]">
            <div className=" flex justify-start w-full">
              <img
          ...
          <div className="flex justify-between border-[2px] rounded-[20px] border-[#333] h-[268px] xl:h-[343px]  bg-[#fce3e7] px-[1.5rem] flex-col pt-[1.5rem] pb-[2rem] w-[26%] mr-[1.5%] mb-[1.5%]">
            <div className=" flex justify-start w-full">
              <img
          ...
          <div className="flex justify-between border-[2px] rounded-[20px] border-[#333] h-[268px] xl:h-[343px]  bg-[#faf8cd] px-[1.5rem] flex-col pt-[1.5rem] pb-[2rem] w-[40%] mr-[1.5%] mb-[1.5%]">
            <div className=" flex justify-end w-full">
              <img
          ...
          <div className="flex justify-between border-[2px] rounded-[20px] border-[#333] h-[268px] xl:h-[343px]  bg-[#e1f2f1] px-[1.5rem] flex-col pt-[1.5rem] pb-[2rem] w-[31%]  mb-[1.5%]">
            <div className=" flex justify-end w-full">
              <img
